...
### OnPrem
Sie erhalten von uns die Objekte für die Connector 365 Base & Mail Experience Pro App per Mail, damit Sie die App nutzen können, müssen diese zunächst veröffentlicht und anschließend installiert werden.

#### Veröffentlichen der Connector 365 Base & Mail Experience Pro App
Das veröffentlichen der Connector 365 Base & Mail Experience Pro App erfolgt via der **Business Central Administration Shell**. Transferieren Sie zunächst die von uns an Sie gesendete Dateien auf dem Server auf dem Ihre Business Central Instanz läuft.
...
Anschließend sollten Sie den Prozess auch noch für die eigentliche Connector 365 Mail Experience Pro App durchführen

**Beispiel:**

```Publish-NAVApp -ServerInstance IhreBusinessCentralInstanz -Path ".\MailSenderPro.app"```
...
#### Installieren der Connector 365 Base & Mail Experience Pro App
...
Es folgt noch die Connector 365 Mail Experience Pro App:

**Beispiel:**

```Install-NAVApp -ServerInstance IhreBusinessCentralInstanz -Name "Connector 365 Mail Experience Pro" -Tenant Tenant1, Tenant2```

Sie können nun mit der [Einrichtung](/de-de/apps/mail-experience-pro/first-steps/setup/) starten.
