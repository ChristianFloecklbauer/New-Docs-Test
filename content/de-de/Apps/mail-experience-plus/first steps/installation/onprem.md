...
### OnPrem
Sie erhalten von uns die Objekte für die Connector 365 Base & Mail Experience Plus App per Mail, damit Sie die App nutzen können, müssen diese zunächst veröffentlicht und anschließend installiert werden.

#### Veröffentlichen der Connector 365 Base & Mail Experience Plus App
Das veröffentlichen der Connector 365 Base & Mail Experience Plus App erfolgt via der **Business Central Administration Shell**. Transferieren Sie zunächst die von uns an Sie gesendete Dateien auf dem Server auf dem Ihre Business Central Instanz läuft.
...
Es folgt noch die Connector 365 Mail Experience Plus App:
